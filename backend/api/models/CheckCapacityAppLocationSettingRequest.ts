...
export class CheckCapacityAppLocationSettingRequest {
    /**
    * The id of the server configuration to check against
    */
    'serverConfigId': number;
    'placement': CheckCapacityAppLocationSettingRequestPlacement;
    /**
    * Password required when the selected location is password-protected.
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "placement",
            "baseName": "placement",
            "type": "CheckCapacityAppLocationSettingRequestPlacement",
            "format": ""
        },
        {
            "name": "password",
    ...
    static getAttributeTypeMap() {
        return CheckCapacityAppLocationSettingRequest.attributeTypeMap;
    }
